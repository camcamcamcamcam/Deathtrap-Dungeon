...
public class Text {
	...
	public static String text(int whichPage) {
		...
		case 7:
			return "Before you have time to reach a doorway, the boulder is "
					+ "upon you. You cry out in pain and terror as it crushes you to the "
					+ "floor. Your adventure ends here.  ";

		case 8:
			return "The Mirror Demon grabs you by the wrist. Immediately it "
		...
		case 9:
			return "The Hobgoblins have nothing of any use to you on them, so "
					+ "you decide to open the bag on the floor. Inside it you find a corked "
					+ "earthenware jug. You uncork it and sniff the liquid inside. It smells " + "sharp and acrid.  ";
		case 10:
			return "Still running as fast as you can, you reach into your "
		...
		case 11:
			return "You look down and see the crumpled bodies of the Flying "
		...
		case 12:
			return "The door opens into a large, candle-lit room filled with "
		...
		case 13:
			return "The tunnel makes a sudden turn to the left and heads "
		...
		case 14:
			return "The tunnel leads into a dark chamber covered in thick "
					+ "cobwebs. Clawing your way through them, you trip over a wooden " + "casket.  ";

		case 15:
			return "A tickling sensation runs down your spine as you crawl "
		...
		case 17:
			return "You are not strong enough to force open the heavy door. "
		...
		case 18:
			return "Luckily for you, the cobra's fangs sink into your leather "
					+ "waistband. The snake recoils quickly, ready to strike again, as the "
					+ "Dwarf tells you to have another try.  ";

		case 19:
			return "You cannot resist the Medusa's beguiling gaze as she "
		...
		case 21:
			return "The wound has no effect on the Bloodbeast, and it "
					+ "continues to attack you as furiously as before.  ";

		case 22:
			return "Although you are slightly uneasy in each other's company, "
					...
					+ "rope, saying he has a torch which he can light for you to use. What " + "will you do?  ";

		case 23:
			return "The paper bears a simple warning written in dried blood: "
					+ "'Beware the Trialmasters'. You replace the paper on its nail and run "
					+ "back down the tunnel to rejoin the Barbarian.  ";

		case 24:
			return "Set back in an arched alcove in the tunnel wall you see "
					+ "an ornate wooden chair carved in the shape of a demon-like bird of " + "prey.   ";

		case 25:
			return "Although the temperature in the tunnel is higher than you "
		...
		case 26:
			return "The pill makes you feel dull and lethargic. " + Deathtrap.character.changeSkill(-2)
					...
					+ "crouch down on the floor, tensing yourself for the moment in which to " + "seize it.  ";

		case 27:
			return "You step up to the frightened man and cleave the chains "
		...
		case 29:
			return "The tunnel leads north for some distance before coming to "
		...
		case 30:
			return "Taking a step forward, you leap towards the far edge of " + "the pit.  ";

		case 31:
			return "The Gnome smiles and says, 'Good. Now, do you have a " + "sapphire in your possesion?'  ";

		case 32:
			return "You soon come to another junction in the tunnel. One "
		...
		case 34:
			return "You try to force the point of your sword under the "
		...
		case 35:
			return "The tunnel continues west for several hundred metres, "
		...
		case 36:
			return "You run faster than you have ever run in your life "
					+ "before, but still the boulder is catching up with you.  ";

		case 37:
			return "The passage opens out into a wide cavern which is darker "
		...
		case 39:
			return "You manage to evade the outstretched legs of the diving "
					+ "Giant Fly. Stepping back, you draw your sword and prepare to fight "
					+ "the hideous insect as it turns to attack you again.  ";

		case 40:
			return "You call out to the Dwarf that you are ready to fight the "
		...
		case 41:
			return "You walk slowly over to the alcove, carefully checking "
		...
		case 43:
			return "The tunnel turns sharply to the right and continues north "
					+ "for as far as you can see. There is a door in the left-hand wall "
					+ "which is ajar. You hear someone cry for help from the other side of " + "the door.  ";

		case 44:
			return "You are only a few metres from the doorway when you hear "
		...
		case 46:
			return "You lower yourself carefully down the idol and, wasting "
					+ "no more time in the cavern, run forward to the tunnel in the northern " + "wall.  ";

		case 47:
			return "";

		case 48:
			return "Only your immense strength and grim determination keep "
					+ "you from falling unconsious to the floor. You grit your teeth and " + "press on resolutely.  ";

		case 49:
			return "You peep around the corner and see two small creatures "
					+ "running away from you. Both are dressed in baggy clothes and wear "
					+ "pointed floppy hats. They are mischevious LEPRECHAUNS.   ";

		case 50:
			return "You wake to find Throm pulling the ring off your finger. "
		...
		case 51:
			return "The Hobgoblins are unprepared for your attack, and you "
		...
		case 52:
			return "As you open the book, it starts to disintegrate and the "
					...
					+ "grotesque Bloodbeast, but he merely shrugs his shoulders and tells " + "you to get going.  ";

		case 53:
			return "The Bloodbeast is too bulbous to climb out of its pool, "
		...
		case 54:
			return "The lasso loosens itself and you are able to shake it "
					...
					+ "no more time in the cavern, you run forward to the tunnel in the " + "northern wall.  ";

		case 55:
			return "With lightning speed, you thrust your hand out and grip "
					...
					+ "cannot identify either, just hit enter";

		case 56:
			return "You see that the obstruction is a large, brown, "
					+ "boulder-like object. You touch it with your hand and are surprised to "
					+ "find that it is soft and spongy.  ";

		case 57:
			return "Although you check the chest carefully for any hidden "
		...
		case 59:
			return "Ahead in the far distance you hear the sound of slow "
		...
		case 60:
			return "The tunnel ends at a large oak door. Throm wastes no time "
					...
					+ "ear that you should try to kill the Dwarf and worry about the exit " + "later.  ";

		case 61:
			return "Despite the terrible ringing sound in your ears, you hear "
		...
		case 62:
			return "The Gnome jumps in the air, yelling, 'Well done - nobody "
		...
		case 63:
			return "You tie the rope around your waist and take hold of the "
		...
		case 64:
			return "As soon as you put the ring on your finger, your whole " + "body starts to shake.  ";

		case 65:
			return "  ";

		case 66:
			return "After walking down the tunnel for a few minutes, you come "
					...
					+ "decided to follow the direction of the arrow, while one decided to go " + "east.  ";

		case 67:
			return "You grab onto one of the underwater bridge pillars and "
		...
		case 68:
			return "You walk down the passage and soon find yourself standing "
		...
		case 69:
			return "Ivy does not notice you opening the door. You slip out of "
					+ "her room, close the door quietly behind you and find yourself at the "
					+ "end of another tunnel.  ";

		case 70:
			return "You just manage to dive to the side before the boulder "
		...
		case 71:
			return "Once again you reach for the parchment, only this time it "
					...
					+ "backpack. Repeating the rhyme over and over to yourelf, you walk " + "across to the alcove.  ";

		case 72:
			return "The Mirror shatters, sending fragments of glass flying "
		...
		case 74:
			return "The tunnel takes a sharp right turn and you find yourself "
					...
					+ "a MIRROR DEMON from another dimensional plane, come to take your " + "spirit.  ";

		case 75:
			return "You rub the liquid into your wounds, but they do not "
					+ "heal. Staring into the empty bottle, you wonder exactly what the " + "liquid was.  ";

		case 76:
			return "You step round the great bulk of the dead Rock Grub and "
		...
		case 77:
			return "You stagger through the open doorway into another tunnel, "
		...
		case 78:
			return "There is an open pipe in the right-hand wall, about a "
					+ "metre in diameter. It is too dark to see far down it. You shout into "
					+ "it and hear your voice echoing down the iron pipe until eventually " + "the sound fades away.  ";

		case 79:
			return "You grip the arms of the chair tightly, half expecting a "
					+ "surge of energy or pain to rush through your body.  ";

		case 80:
			return "You take your time and manage to step over the last pole "
					+ "without having touched any of them. You hurry on east, still "
					+ "following the two pairs of footprints.  ";

		case 81:
			return "The only furniture in the Goblin's room is a table, two "
					+ "chairs and a cupboard on the wall. There are two closed doors, one in "
					+ "the west wall and the other in the north wall.  ";

		case 82:
			return "As the Pit Fiend slams its body against the wall, you let "
					...
					+ "them. You let them swing shut behind you and head north along the " + "tunnel.  ";

		case 83:
			return "The passage soon leads to a junction. You notice more "
		...
		case 85:
			return "Before you are able to do anything else, the old man "
					...
					+ "nothing you can do to stop the petrification of your body. Your " + "adventure ends here.  ";

		case 86:
			return "The key turns in the lock and the door opens into a "
		...
		case 87:
			return "The door opens into a large room.  ";

		case 88:
			return "As soon as they see you, the TROLOGDYTES raise their bows "
		...
		case 89:
			return "Back on solid ground once again on the cavern floor, you "
					+ "try to shake the rope off the idol's neck.  ";

		case 90:
			return "As soon as you stand up, you are confronted with the most "
		...
		case 91:
			return "The Orc's morning star thuds into your arm, knocking your "
					+ "sword to the floor. You must fight them bare-handed (which reduces your skill by four points), for the duration " + "of the combat. "
					+ "Fortunately, the tunnel is too narrow for both Orcs to attack you "
					+ "at once. Fight them one at a time.  ";

		case 92:
			return "Summoning all your strength, you deal the Mirror Demon "
		...
		case 93:
			return "The door opens into a small dark room, which is empty "
		...
		case 94:
			return "Taking a deep breath, you lean over the pit and plunge "
		...
		case 97:
			return "Unknown to you, the Bloodbeast has only one weakness: its real "
		...
		case 98:
			return "Lifting the goblet releases a sprung catch, and a dart shoots out " + "of the wooden table leg.";

		case 99:
			return "Smiling, you tell Ivy that you think she and Sourbelly look very "
		...
		case 100:
			return " Only a few metres further down the passage, you see another "
					+ "closed door in the left-hand wall. The letter X is scratched into "
					+ "his centre panel. Putting your ear to the door, you listen " + "intently but can hear nothing.";

		case 101:
			return " The river current is very strong and, encumbered by your armour "
		...
		case 102:
			return "You enter a room which is small and completely empty. As soon as "
		...
		case 104:
			return "Reacting quickly, you manage to jump over the outstretched tongue "
					...
					+ "pool to await another victim. ";
		case 105:
			return "Your reflexes are sharp and you quickly jump aside. The dart "
					...
					+ "may be of use, so you put it in your backpack.";
		case 106:
			return "Squeezing the arm of the chair triggers a secret panel which "
					...
					+ "nearby being.' You place the strange potion in your backpack and " + "continue north.";
		case 107:
			return "You come to an arched doorway set in the right-hand wall of the "
					+ "tunnel. The heavy stone door is closed, but there is an iron " + "latch and a round handle.";
		case 108:
			return "There is a large panel of glass in the left-hand wall of the "
					...
					+ "diamond is set in the middle of the crown.";
		case 109:
			return "You arrive at another junction in the tunnel.";
		case 110:
			return "The tunnel takes another sharp right turn. Following it east, you "
					...
					+ "off the floor and spaced a metre apart.";
		case 111:
			return "You wipe the vile yellow slime from the blade of your sword and "
		...
		case 114:
			return "The Caveman is wearing a leather wristband with four small rats' " + "skulls hanging from it.";
		case 115:
			return "Your body continues to vibrate intensely and you feel as if you "
		...
		case 116:
			return "You cannot believe that the Bloodbeast is unaffected by its new "
					+ "wound. You hesitate a moment too long and it lunges forward, "
					+ "cracking your skull with its jaws. Then it drags you into its "
					+ "pool, where you will be predigested and later consumed by the " + "hideous creature.";
		case 117:
			return "After a long walk down the tunnel, you come to a dead end. A "
					+ "large mirror reaching from the ceiling to the floor hangs on the "
					+ "end wall, and in the dim light you can just about make out your " + "own reflection.";
		case 118:
			return "Despite the stalactites crashing all around, you manage to dash "
					...
					+ "smile and head east once more.";
		case 119:
			return "Although you can see a large obstruction on the tunnel floor, "
					+ "although it is too dark to make out exactly what it is. The wet "
					+ "footprints you have been following carry on towards the " + "obstruction.";
		case 120:
			return "Lying in a hole about a metre deep, you see a grappling iron and " + "a leather pouch.";
		case 121:
			return "The Dwarf looks at the dice. 'Not very good at playing the odds, "
					...
					+ "letter L. He asks you to choose one and swallow it.";
		case 122:
		...
		case 124:
			return "You throw the trapdoor open and run up the steps into a bright, "
					...
					+ "momentarily off guard, but they quickly recover and both rush " + "forward to attack you.";
		case 125:
			return "You tiptoe towards the door while Ivy prattles on.";
		case 126:
			return "The pouch on the Barbarian's belt is empty apart from some strange-looking dried meat "
					+ "wrapped in a cloth.";
		case 127:
			return "The only possible way out of the hall as far as you can see is by "
					...
					+ "another room, landing on your back.";
		case 128:
			return "At the back of the alcove are some steps leading down into a "
					...
					+ "mushrooms growing on the rubbish to your right.";
		case 129:
			return "You tie the rope over the grappling iron and hurl it over the top "
		...
		case 130:
			return "The Hobgoblins stop their fight immediately. They do not "
					+ "understand what you are saying and snarl at you viciously. Then "
					+ "they draw their short swords and run forward to attack you.";
		case 131:
			return "The crossbow bolts fly over our head and thud into the opposite "
		...
		case 133:
			return "Once again the mysterious voice calls out, only this time its "
					...
					+ "desperation you try ramming it with your shoulder.";
		case 134:
			return "The tunnel leads into a large room, its ceiling supported by "
					...
					+ "dragon-like wings attached to it, but its head is like that of an " + "old bearded man.";
		case 135:
			return "Passing the Rock Grub's borehole on your left, you soon arrive at "
					+ "the junction. You take a quick look south, but do not see anyone "
					+ "approaching. Quickening your step, you hurry on east.";
		case 136:
			return "The door opens into another tunnel, which rises gently into the "
					+ "distance. After walking uphill for a while, the tunnel levels out "
					+ "and you soon arrive at a door in the right-hand wall, to which a " + "withered hand is nailed.";
		case 137:
			return "Walking along the tunnel, you are surprised to see a large iron "
					+ "bell hanging down from the ceiling.";
		case 138:
			return "The book's pages are sealed together, but a small hole has been "
		...
		case 140:
			return "You try to force your sword under the emerald eye. Much to your "
					...
					+ "backwards, bouncing down the idol to land on the stone floor. " + "Your adventure ends here.";
		case 141:
			return "The Mirror Demon is almost on top of you when, summoning all your "
					+ "strength, you strike one final blow against the mirror with your " + "sword.";
		case 142:
			return "There is a new branch in the tunnel on your left, and ahead you "
					+ "see two bodies lying on the floor. You stop and peer down the "
					+ "tunnel, but seeing no doors and creatures you decide against "
					+ "walking down it. With your sword drawn, you walk over to where " + "the bodies lie.";
		case 143:
			return "You call out to the Dwarf, telling him to send in the SCORPION "
		...
		case 144:
			return "Still smiling, the old man looks at you and says quietly, 'Wrong.'";
		case 145:
			return "The Dwarf is expecting your move. Furthermore, you are not as "
